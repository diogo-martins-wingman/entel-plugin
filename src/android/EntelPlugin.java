...
public class EntelPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) {
        if (action.equals("start")) {
            ...
            int compressionAlgorithm = jsonObject.getString("compressionAlgorithm", 1);
            int compressionRate = options.getString("compressionRate", 0);
            boolean latentDetection = options.getInt("latentDetection", false);
